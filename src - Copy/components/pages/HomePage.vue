<template>
  ...
  <header class="header" id="intro">
    <nav class="navbar">
      <div class="container">
        <div class="brand-and-toggler">
          <a href="/" class="navbar-brand"> Guton<span></span> </a>
    ...
    <div class="hero-div center container">
      <h1>we help you get the desired home</h1>
      <p class="animate__animated animate__fadeInUp animate__slow">
        We have plots all over Kenya with reasonable prices. get in touch to  view and get payment arrangements <strong></strong> 
      </p>
      ...
      <div class = "container">
        <div class = "row">
          <div class = "feature-left wow animate__animated animate__fadeInUp animate__slow">
            <img src = "../../assets/titledeed.jpg" alt = "tako image">
          </div>
          <div class = "feature-right wow animate__animated animate__fadeInUp animate__slow">
            <div class = "title">
              <h2>This is what we offer</h2>
              <p class = "text">We have plots in different parts of the county with competitive pricing</p>
            </div>

            <div class = "feature-item">
              <span><i class = "fas fa-tablet-alt"></i></span>
              <div>
                <h3>Monthly installements</h3>
                <p class = "text">            You can get a plot and make monthly payment until you finish without any interest
</p>
              </div>
            </div>
      ...
      <div class = "container">
        ...
        <div class = "row wow animate__animated animate__fadeInUp animate__slow">
          <div class = "pricing-item">
            ...
            <div class = "price">
              <span></span>
              <span class = "text">We have plots in different parts of the county with competitive pricing</span>
            </div>
            <ul>
              <li>We provide serviced plots</li>
              <li>We help you get the search and titles</li>
    ...
    <section class = "testimonial" id = "testimonial">
      <div class = "container">
        <div class = "title">
          ...
          <!-- <p class = "text">I git the plot hustle free from Guton</p> -->
        </div>
        ...
        <div class = "row owl-carousel owl-theme wow animate__animated animate__fadeInUp animate__slow">
          <div class = "testimonial-item">
            ...
            <p>The title came within one month after payment completeion</p>
            <span>Ronnie</span>
          </div>
          ...
          <div class = "testimonial-item">
            ...
            <p>The tarmak came as promised and the plot has appreciated</p>
            <span>Evans</span>
          </div>
        ...
        <div class = "row wow animate__animated animate__fadeInUp animate__slow">
          ...
          <div class = "contact-right">
            <div>
              ...
              <h2>Visit us</h2>
              <p class = "text">Solar house, off moi avenue, 3rd floor, room 314</p>
            </div>
            <div>
              <h2>Call Us</h2>
              <p class = "text">0115 855772</p>
            </div>
            <div>
              <h2>Send Email</h2>
              <p class = "text">gutonkenyaltd@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
...
/* Headers */
.header {
  background-image: linear-gradient(rgba(16, 19, 16, 0.8), rgba(100, 110, 104, 0.7)), url(../../assets/city.jpeg);
  min-height: 100vh;
...
/* testimonial */
.testimonial{
    background-image: linear-gradient(rgba(27, 188, 156, 0.8), rgba(27, 188, 156, 0.9)), url(../../assets/city.jpeg);
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center;
    background-attachment: fixed;
